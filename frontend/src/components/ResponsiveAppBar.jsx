...
const pages = [
  { name: 'Home', route: '/' },
   { name: 'Start Quiz', route: '/start' },
  // { name: 'Result', route: '/result' },
  { name: 'Leaderboard', route: '/leader' },
    ...
    <AppBar position="static">
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          ...
          <QuizIcon sx={{ display: { xs: 'none', md: 'flex' }, ml: 10,mr:1 }} />

          <Typography variant="h6" noWrap component={Link} to="/" sx={{ mr: 5, display: { xs: 'none', md: 'flex' }, fontFamily: 'monospace', fontWeight: 700, letterSpacing: '.2rem', color: 'inherit', textDecoration: 'none' }}>
            QuizCrack
          </Typography>
          ...
          <Typography variant="h5" noWrap component={Link} to="/" sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' }, fontFamily: 'monospace', fontWeight: 700, letterSpacing: '.2rem', color: 'inherit', textDecoration: 'none' }}>
            QuizCrack
          </Typography>
